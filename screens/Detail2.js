...
export default function Detail2({navigation}) {
    const image = { uri: "https://images.unsplash.com/photo-1595560006870-71deded44269?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=387&q=80" };
  return (
